...
export default function TalkToUs() {
  return (
    <section className="relative py-16 border-t border-base">
      <div className="max-w-3xl mx-auto px-6 lg:px-8 text-center">
        <div className="glass-card border border-base rounded-2xl px-10 py-12">
          ...
          <h2 className="text-2xl lg:text-3xl font-extrabold text-base tracking-tight mb-3">
