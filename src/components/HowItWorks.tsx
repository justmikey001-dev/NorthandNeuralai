...
export default function HowItWorks() {
  ...
  return (
    <section id="how-it-works" className="relative py-24 lg:py-32 border-t border-base">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div ref={gridRef} className="reveal grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
          {STEPS.map((step, i) => (
            <div key={step.num} className="relative">
              ...
              <div className="glass-card card-hover p-6 h-full">
                <div className="flex items-center justify-between mb-5">
                  ...
                  <span className="text-3xl font-extrabold text-base opacity-10">{step.num}</span>
                </div>
                <h3 className="text-base font-semibold text-lg mb-2.5">{step.title}</h3>
